    ...
    <section id="chefs" class="chefs section-bg mt-5">
        <div id="book-a-table" class="container" data-aos="fade-up">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="65">
                        <div class="chef-member">
                            <div class="member-img">
                                <img src="{{ asset('images/' . $mahasiswa->foto) }}" class="img-fluid" alt="">
                                <div class="social">
                                    <a href="" class="bg-dark fw-bold">
                                        <p class="text-dark">Berita</p>
                                    </a>
                                    <a href="http://twitter.com/home/?status=" target="_black"><i
                                            class="bi bi-twitter"></i></a>
                                    <a href="http://www.facebook.com/share.php?u=" target="_black"><i
                                            class="bi bi-facebook"></i></a>
                                    <a href="http://www.instagram.com/share.php?u=" target="_black"><i
                                            class="bi bi-instagram"></i></a>
                                    <a href="http://web.whatsapp.com/share.php?u=" target="_black"><i
            ...
            <div class="d-flex justify-content-center" style="align-items: center">
                <a href="/berita" type="button" class="btn btn-primary my-5 rounded-pill">Berita Selengkapnya<i
