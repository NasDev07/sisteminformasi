...
@section('container')
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-8 mt-5">
            <a href="/tujuh" class="btn btn-primary btn-sm rounded-pill"><span>SEMESTER VII</span></a>
                ...
                <table class="table table-hover mt-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>1</th>
                            <td>TSI4173 </td>
                            <td class="text-danger">MEDIA SOSIAL DAN PEMASARAN ONLINE</td>
                            <td>3</td>
                            <td>TSI3463</td>
                            <td>
                        ...
                        <tr>
                            <th>3</th>
                            <td>TSI4372</td>
                            <td>BAHASA INGGRIS (PERSIAPAN TOEFL) 2</td>
                            <td>2</td>
                            <td>TSI4062</td>
                            <td>
                                <a type="button" class="btn " data-bs-toggle="modal" data-bs-target="#exampleModal">
                        ...
                        <tr>
                            <th></th>
                            <td></td>
                            <td><i class="bi bi-arrow-down-short"></i>MK PILIHAN 3</td>
                            <td>3</td>
                            <td></td>
                            <td>
                                <a type="button" class="btn " data-bs-toggle="modal" data-bs-target="#exampleModal">
                        ...
                        <tr>
                            <th>4</th>
                            <td>TSI5673</td>
                            <td class="text-danger">FORENSIKA DIGITAL</td>
                            <td></td>
                            <td></td>
                            <td>
                                <a type="button" class="btn " data-bs-toggle="modal" data-bs-target="#exampleModal">
